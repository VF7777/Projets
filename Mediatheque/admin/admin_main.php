  ...
  <body class=""> 
    ...
    <div class="content">
        ...
        <div class="header">
            <div class="stats">
            <?php 
$sql1=mysql_query("select * from emprunt,utilisateur where emprunt.IDU=utilisateur.IDU and emprunt.StatutE ='Emprunt' order by DateEmprunt desc");
...
?>
    <p class="stat"><span class="number"><?php echo $empruntNombre;?></span>emprunts en cour(Tous les types)</p>
            ...
            <h1 class="page-title">Gestion d'emprunt et réservation</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="admin_main.php">Afficher des emprunts</a> <span class="divider">/</span></li>
...
<div class="row-fluid">
    ...
    <div class="alert alert-info">
        ...
        <strong>Avis:</strong> Voici tous les emprunts normal avant la date limite
    </div>    
</div>

<div class="row-fluid">

        <a href="#tablewidget" class="block-heading" data-toggle="collapse">Emprunt<span class="label label-warning">+</a>
        <div id="tablewidget" class="block-body collapse in">
            <table class="table" width="776">
              ...
              <tbody>
       <?php do{
   		$DateLimiteRetour=date("Y-m-d",strtotime("$info1[DateEmprunt]+ 30 days"));        //30 jours après la date d'emprunt
