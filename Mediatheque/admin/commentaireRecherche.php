...
checkLogin();
$resultA = mysql_query("select * from commentaire");
...
<html lang="fr">
  ...
  <body class=""> 
    ...
    <a href="#error-menu2" class="nav-header collapsed" data-toggle="collapse"><i class="icon-exclamation-sign"></i>Emprunt et réservation<i class="icon-chevron-up"></i></a>
        ...
        <a href="#legal-menu" class="nav-header " data-toggle="collapse"><i class="icon-legal"></i>Gestion de commentaire<i class="icon-chevron-up"></i></a>
    ...
    <div class="content">
        ...
        <div class="header">
            <div class="stats">
    <p class="stat"><span class="number"><?php echo $number;?></span>commentaires dans la base de données</p>
</div>

            <h1 class="page-title">Gestion des Commentaire</h1>
        </div>
        
                <ul class="breadcrumb">
                 <li class="active">Gestion des Commentaire<span class="divider">/</span></li>
            <li><a href="commentaireRecherche.php">Rechercher des commentaire</a> </li>
...
<table width="780" height="100" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #9CBED6; margin-top:15px;">
	<tr>
		<td align="center" valign="top">
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#DDDDDD">
<tr bgcolor="#E7E7E7">
		<td height="28" colspan="10" background="img/tbg.gif" align="center">
		<b>Recherche des comentaires</b>
		</td>
	</tr>
<tr>
    <td height="60" align="center" valign="top" bgcolor="#FFFFFF">

	<form name="table" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
       <table width="98%" border="0" cellspacing="1" cellpadding="1">
          <tr> 
            <td height="60">Mot clef :</td>
            <td><input name="motCle" type="text" id="motCle" size="16" style="width:200px"/></td>
            <td height="60">&nbsp;</td>
...
$pageLink = 'commentaire.php';
if($page<1)$page = 1;
$pagenum = intval($number/10)+(($number%10)==0?0:1);
if(isset($_POST['motCle']))
{
$motCle=$_POST['motCle'];
$result = mysql_query("select * from commentaire,utilisateur,ressource where  commentaire.IDU=utilisateur.IDU and ressource.IDR=commentaire.IDR and texte like '%$motCle%'");}
...
<tr align='center' height="22"   bgcolor="#FFFFFF" align="center">
	...
	<td>                      
   <img src='images/del.png' title="Supprimer" alt="Supprimer" onclick="location='db_commentaire.php?action=del&id=<?php echo $row['idC'];?>';"  style='cursor:pointer' border='0' width='16' height='16' />
	</td>
