...
<tr>
	...
	<form name="table" action="db_admin.php?action=pwd" method="post">
       <table width="98%" border="0" cellspacing="1" cellpadding="1">
          <tr> 
            <td height="30" width="9%">Nom administrateur：</td>
            <td  width="91%"><?php echo $_SESSION['name'];?></td>
          </tr>
          <tr> 
            <td height="30">Mot de passe :</td>
            <td><input name="pwd1" type="password" id="pwd1" size="16" style="width:200px"/></td>
          </tr>     
          <tr> 
            <td height="60">&nbsp;</td>
