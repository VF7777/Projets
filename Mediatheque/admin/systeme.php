...
<html lang="fr">
  ...
  <body class=""> 
    ...
    <p class="stat"><span class="number"><?php echo $number;?></span>administrateurs</p>
            ...
            <h1 class="page-title">Gestion des Système</h1>
        </div>
        
                <ul class="breadcrumb">
                 <li class="active">Gestion des Système</li>
...
<form name="form1" action="db_sysinfo.php" enctype="multipart/form-data" method="post" >
...
<?php 
$result = mysql_query("select * from systeme");
...
?>
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="180">&nbsp;<?php echo $row['nom'];?>：</td>
          <td>
          	<input name="<?php echo $row['id'];?>" type="text" id="<?php echo $row['id'];?>" value="<?php echo $row['valeur'];?>" style="width:388px">
          </td>
          <td width="90"></td>
          <td></td>
        </tr>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <td width="5%" ></td>
      <td width="45%" align="left"><input type="submit" value="Confirmer"></td>
  </tr>
