  ...
  <body class=""> 
    ...
    <div class="content">
        ...
        <div class="header">
            <div class="stats">
            <?php 
$sql1=mysql_query("select * from emprunt,utilisateur where emprunt.IDU=utilisateur.IDU and emprunt.StatutE ='Reservation' order by DateReserve desc");
$info1=mysql_fetch_array($sql1);
$empruntNombre=mysql_num_rows($sql1);     //Obtenir le nombre de ligne
            ?>
    <p class="stat"><span class="number"><?php echo $empruntNombre;?></span>réservations en cour</p>
</div>
            ...
            <li><a href="admin_reservation.php">Afficher des réservations</a> </li>
...
<div class="row-fluid">
    ...
    <div class="alert alert-info">
        ...
        <strong>Avis:</strong> Vous pouvez consulter tous les réservations 
    </div>    
</div>

<div class="row-fluid">

        <a href="#tablewidget" class="block-heading" data-toggle="collapse">Réservation<span class="label label-warning">+</a>
        <div id="tablewidget" class="block-body collapse in">
            <table class="table" width="776">
              ...
              <tbody>
       <?php do{
   		$DateLimiteRetour=date("Y-m-d",strtotime("$info1[DateReserve]+ 2 days"));        //2 jours après la date Reserve
   		$jour=floor((strtotime($DateLimiteRetour)-strtotime(date('Y-m-d')))/86400);   		 		
   		?>
                <tr>
                  <td>      <?php echo $info1[DateReserve];?></td>
