...
<html lang="fr">
  ...
  <body class=""> 
    ...
    <div class="content">
        ...
        <div class="header">
            <div class="stats">
    <p class="stat"><span class="number"><?php echo $number;?></span>utilisateurs</p>
</div>
            ...
            <li><a href="utilisateur.php">Afficher des utilisateurs</a> </li>
...
$pageLink = 'utilisateur.php';
if($page<1)$page = 1;
$pagenum = intval($number/10)+(($number%10)==0?0:1);
$result = mysql_query("select * from utilisateur order by IDU asc limit ".(($page-1)*10).",10");
...
<tr align='center' height="22"   bgcolor="#FFFFFF" align="center">
	...
	<td><?php if($row['bloque'] ==0) { ?>
                         Non Bloqué
<?php }else {?>Bloqué
<?php }?></td>
	   <td>                      
      <img src='images/plo.png' title="Supprimer" alt="Supprimer" onclick="location='db_utilisateur.php?action=del&id=<?php echo $row['IDU'];?>';"  style='cursor:pointer' border='0' width='16' height='16' />
	</td>
	<?php 
    if($row['bloque'] ==1) {  ?>                      
      <td width="12%" align="center"><a href="db_utilisateur.php?action=debloquer&id=<?php echo $row['IDU'];?>">Débloquer compte</a>&nbsp;</td>
<?php     }    ?>  
