...
<html lang="fr">
  ...
  <body class=""> 
    ...
    <p class="stat"><span class="number"><?php echo $number;?></span>commentaires dans la base de données</p>
            ...
            <li><a href="commentaire.php">Afficher des commentaire</a> </li>
...
$result = mysql_query("select * from commentaire,utilisateur,ressource where  commentaire.IDU=utilisateur.IDU and ressource.IDR=commentaire.IDR order by dateC desc limit ".(($page-1)*10).",10");
...
<tr align='center' height="22"   bgcolor="#FFFFFF" align="center">
	...
	<td><?php echo substr($row['texte'],0,20);?></td>
	<td>                      
