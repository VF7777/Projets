	...
	<div class="page-wrap">
		...
		<div class="main-content">
			...
			<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=roman';?> class="center-img">
				...
				<div class="black-border"><p> ROMAN</p> 
				</div>
			</a>
			
				
			<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=culture';?>  class="body-left">
				<div>
				<img src="images/literature.jpg" width="230" height="143">
				<div class="black-border"><p>Culture</p>  
				</div>
				</div>
			</a>
		<a  href=<?php echo'AfficherLivreParCategorie.php?catL_id=enfant';?>  class="body-right">
