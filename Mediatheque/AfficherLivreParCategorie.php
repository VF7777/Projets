		...
		<div class="main-content">
			...
			<div class="body-contents">
			   ...
			   <?php while ($donnees = $req->fetch()) {?>
				...
				<div class="center">
		<div class="center">
		    <p ><a href="livre.php" class="txthead">Categorie>><span class="categorie"><?php echo$_GET['catL_id'] ?></p>
	        <?php
			   $com=0;

			   require("config.inc.php");
				$req = $bdd->prepare('SELECT * FROM ressource,livre WHERE type="livre" and IDR=IDL and GenreL="'.$_GET['catL_id'].'"');
				$req->execute();
				 ...
				 <td>
				   <table>
					<tr>
						...
						echo '<a href="blanc.php?article_id='.$donnees['IDR'].'"><img src=' .$donnees['Image']. ' width=120 height=180/><br>';
					...
					<tr >
						<td width="120"><p class="description">by<span class="green-text"><?php echo $donnees['Auteur'] ?></span></p></td>
					</tr>
					<tr>
