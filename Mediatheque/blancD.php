		...
		<div class="main-content">
			...
			<div class="body-contents">
				...
				<div class="the-latest">					
					<div class="txthead">Les Noueaux</div>
                <?php
              try
				{
...
<div class="center">
		<?php
                   ...
                   $info = $res->fetch();
						...
						echo '<br>';
						echo '<iframe width="420" height="345" src='.$info['Ressource'].'>
							</iframe>';
						echo '<br>';
        ...
        $p = $bdd->prepare('select * from exemplaire where Etat=1 and IDR='.$info['IDR'].'');
							...
							{
							 echo '<input type="button" class="ButtonNondisponible" name="action" value="NonDisponible"/></form>';
							}else{
      ...
      ?>
      		  <table class="commentaire" height:"800px" style="border: #CCC dashed 1px; margin-bottom:20px"  width="500px"> 
		</table>
