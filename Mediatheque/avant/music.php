		...
		<div class="main-content">
			...
			<div class="body-contents">
             ...
             require("config.inc.php");
				$bdd = connect_db();
				$req = $bdd->prepare('SELECT DISTINCT * FROM ressource,music WHERE type="music" and IDR=IDM and IDR >((SELECT MAX(IDM)FROM music )-3) ');
				$req->execute();
				?>
			   ...
			   <?php while ($donnees = $req->fetch()) {?>
				...
				<table>
					...
					<tr>
						<a href="blancM.php?article_id=<?php echo $donnees['IDM']?>"><img src=<?php echo $donnees['Image'] ?> width="120" height="180"><br>
					</tr>
					<tr>
			...
			<a href=<?php echo'AfficherMusicParCategorie.php?catM_id=pop';?> class="center-img">
				<img src="images/pop.jpg" width="472" height="276">
				<div class="black-border"><p> POP </p> 
				</div>
			</a>
			
				
			<a href=<?php echo'AfficherMusicParCategorie.php?catM_id=jazz';?>  class="body-left">
				<div>
				<img src="images/jazz.png" width="230" height="143">
				<div class="black-border"><p> JAZZ</p>  
				</div>
				</div>
			</a>
		<a  href=<?php echo'AfficherMusicParCategorie.php?catM_id=classic';?>  class="body-right">
			
			<img src="images/classic.jpg" width="228" height="143">
			<div class="black-border"><p>CLASSIC </p>
			</div>
			
		</a>
				<div  class="clear"></div>
				<a href=<?php echo'AfficherMusicParCategorie.php?catM_id=rock';?> class="center-img"><img src="images/rock.jpg" width="472" height="275"><div class="black-border"><p>ROCK&ROLL</p> 
			</div></a>
