		...
		<div class="main-content">
			...
			<div class="body-contents">
             ...
             require("config.inc.php");
				$bdd = connect_db();
				$req = $bdd->prepare('SELECT DISTINCT * FROM ressource,livre WHERE type="livre" and IDR=IDL and IDR >((SELECT MAX(IDL)FROM livre )-2) ');
				$req->execute();
				$livres = array();?>
			...
			<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=roman';?> class="center-img">
				<img src="images/roman.jpg" width="472" height="276">
				<div class="black-border"><p> ROMANCE </p> 
				</div>
			</a>
			
				
			<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=LITTERATURE';?>  class="body-left">
				<div>
				<img src="images/literature.jpg" width="230" height="143">
				<div class="black-border"><p> LITTERATURE</p>  
				</div>
				</div>
			</a>
		<a  href=<?php echo'AfficherLivreParCategorie.php?catL_id=famille';?>  class="body-right">
			
			<img src="images/enfant.jpg" width="228" height="143">
			<div class="black-border"><p>POUR LES ENFANTS </p>
			</div>
			
		</a>
				<div  class="clear"></div>
				<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=TOURISME ET VOYAGE';?> class="center-img"><img src="images/tourisme.jpg" width="472" height="275"><div class="black-border"><p> TOURISME & VOYAGE</p> 
			</div></a>
			<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=manga';?> class="body-left">
						<img src="images/manga.png"width="230" height="141">
						<div class="black-border"><p> MANGA </p>  
				</div>
		</a>
		<a href=<?php echo'AfficherLivreParCategorie.php?catL_id=science';?>  class="body-right">
			<img src="images/science.jpg"width="228" height="143">
		<div class="black-border"><p> SCIENCE-FICTION </p>   
			</div>
