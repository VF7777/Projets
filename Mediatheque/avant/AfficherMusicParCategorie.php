			...
			<div class="body-contents">
              ...
              try
			   ...
			   <?php while ($donnees = $req->fetch()) {?>
				...
				<div class="center">
		<div class="center">
		    <p ><a href="music.php" class="txthead">Categorie>><span class="categorie"><?php echo$_GET['catM_id'] ?></p>
	        <?php

			   require("config.inc.php");
				$bdd = connect_db();				
				$req = $bdd->prepare('SELECT * FROM ressource,music WHERE type="music" and IDR=IDM and GenreM="'.$_GET['catM_id'].'"');
				$req->execute();
			   ...
			   <?php
				...
				<table>
					<tr>
						...
						echo '<a href="blancM.php?article_id='.$donnees['IDR'].'"><img src=' .$donnees['Image']. ' width=120 height=180/><br>';
					...
					<tr>
						<p class="description">by<span class="green-text"><?php echo $donnees['Artiste'] ?></span></p>
					</tr>
					<tr>
